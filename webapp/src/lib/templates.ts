...
export const generatedTemplates: Record<GradeLevel, GeneratedTemplate[]> = {
  kindergarten: [
    ...
    },
    {
      id: "kg-number-bonds",
      name: "Number Bonds",
      description: "Build number bonds and understand parts",
      icon: "🔗",
      config: {
        title: "Number Bonds to 10",
        subtitle: "Kindergarten - Finding pairs that make 10",
        operation: "addition",
        problemCount: 10,
  ...
  grade1: [
    ...
    },
    {
      id: "g1-doubles",
      name: "Doubles",
      description: "Practice adding same numbers (doubles)",
      icon: "👯",
      config: {
        title: "Doubles Practice",
        subtitle: "Grade 1 - Adding double numbers (2+2, 3+3, etc)",
        operation: "addition",
        problemCount: 10,
  ...
  grade2: [
    ...
    {
      id: "g2-add-100-plus-x",
      name: "100 + X",
      description: "Add to 100, then add more",
      icon: "💯",
      config: {
        title: "100 Plus Numbers",
        subtitle: "Grade 2 - 100 plus other numbers (up to 20)",
        operation: "addition",
        problemCount: 10,
  ...
  kindergarten: [
    {
      id: "kg-exp-add-5s",
      name: "Add 5s",
      description: "Adding 5 to other 5-based numbers",
      icon: "5️⃣",
      config: {
        title: "Add 5s",
        subtitle: "Kindergarten - Adding 5 to multiples of 5",
        problems: [

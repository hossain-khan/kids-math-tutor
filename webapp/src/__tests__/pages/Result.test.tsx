...
describe('Result Component', () => {
  ...
  it('should display challenge result page', async () => {
    sessionStorage.setItem('challengeData', JSON.stringify(generatedChallengeData))
  ...
  it('should copy JSON to clipboard', async () => {
    ...
    const copyToClipboardSpy = vi.spyOn(utils, 'copyToClipboard').mockResolvedValue(true)
  ...
  it('should download JSON file', async () => {
    const user = userEvent.setup()
    const downloadJsonSpy = vi.spyOn(utils, 'downloadJson').mockImplementation(() => {})

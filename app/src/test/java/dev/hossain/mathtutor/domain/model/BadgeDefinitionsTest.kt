...
class BadgeDefinitionsTest {
    @Test
    fun `getAllBadges returns 27 badges`() {
        val badges = BadgeDefinitions.getAllBadges()

        assertThat(badges.size).isEqualTo(27)
    }
    ...
    fun `getAllBadges has correct number of badges per category`() {
        ...
        assertThat(games.size).isEqualTo(12) // 4 original + 4 Memory Match + 4 Number Sequence badges
    }
    ...
    fun `first_steps badge has correct properties`() {
        ...
        assertThat(firstSteps?.icon).isEqualTo(dev.hossain.mathtutor.domain.model.BadgeIcon.FIRST_STEPS)
    ...
    fun `math_legend badge has correct properties`() {
        ...
        assertThat(mathLegend?.icon).isEqualTo(dev.hossain.mathtutor.domain.model.BadgeIcon.MATH_LEGEND)
    ...
    fun `addition_expert badge has correct properties`() {
        ...
        assertThat(additionExpert?.icon).isEqualTo(dev.hossain.mathtutor.domain.model.BadgeIcon.ADDITION_EXPERT)
    ...
    fun `dedication_award badge has correct properties`() {
        ...
        assertThat(dedication?.icon).isEqualTo(dev.hossain.mathtutor.domain.model.BadgeIcon.DEDICATION_AWARD)

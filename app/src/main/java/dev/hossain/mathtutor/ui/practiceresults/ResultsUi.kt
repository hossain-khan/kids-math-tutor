        ...
        Box(
            ...
            Box(
                ...
                LazyColumn(
                    ...
                    // Custom challenge section (if applicable)
                    if (state.customChallengeTitle != null) {
                        item {
                            CustomChallengeResultsCard(
                                challengeTitle = state.customChallengeTitle,
                            )
                        }
                    }
...
@Composable
private fun CustomChallengeResultsCard(
